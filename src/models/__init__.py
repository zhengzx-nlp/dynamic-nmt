...
from .disentangle_lm import DisentangleRNNLM
from .capsule_nmt import CapsuleNMT
from .capsule_transformer import CapsuleTransformer
...
MODEL_CLS = {
    ...
    'RNNLM': DisentangleRNNLM,
    "Capsule": CapsuleNMT,
    "CapsuleTransformer": CapsuleTransformer,
    "DynamicTransformer": DynamicTransformer
}
